  ...
  return (
    <div className="w-full">
      <div className=" font-normal">
        <div className="border-t  border-secondary_2  ">
          <button
            type="button"
            className={`py-4 w-full flex items-center text-[13px] leading-[30px] uppercase font-medium `}
        ...
        <div className="border-t  border-secondary_2">
          ...
          <div>
            <AnimateHeight duration={300} height={active === "2" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-[13px] leading-[30px] border-t border-secondary_2">
        ...
        <div className="border-t border-b border-secondary_2 ">
          <button
            type="button"
            className={`py-4 w-full flex items-center text-[13px] leading-[30px] uppercase font-medium`}
        ...
        <div className="border-b border-secondary_2 ">
          <button
            type="button"
            className={`py-4 w-full flex items-center text-[13.5px] uppercase font-medium`}
          ...
          <div>
            <AnimateHeight duration={300} height={active === "7" ? "auto" : 0}>
              <div className="space-y-2 p-4 text-white-dark text-[13px] leading-[30px] border-t border-secondary_2">
